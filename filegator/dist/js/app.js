(function(e) {
    function a(a) {
        for (var n, t, s = a[0], l = a[1], d = a[2], c = 0, p = []; c < s.length; c++) t = s[c], Object.prototype.hasOwnProperty.call(i, t) && i[t] && p.push(i[t][0]), i[t] = 0;
    ...
    function o() {
        for (var e, a = 0; a < r.length; a++) {
            for (var o = r[a], n = !0, s = 1; s < o.length; s++) {
                var l = o[s];
                0 !== i[l] && (n = !1)
            }
            n && (r.splice(a--, 1), e = t(t.s = o[0]))
        }
        return e
    }
    var n = {},
    ...
    t.m = e, t.c = n, t.d = function(e, a, o) {
    ...
    "93b7": function(e, a, o) {
        ...
        var n = o("2b0e"),
            ...
            c = {
                ...
                downloadItem: function(e) {
                    return new Promise((function(a, o) {
                        d.a.get("download&path=" + encodeURIComponent(u["Base64"].encode(e.path)), {
            ...
            f = m,
            g = (o("5063"), o("2877")),
            h = Object(g["a"])(f, t, s, !1, null, "17127292", null),
            w = h.exports,
            v = {
                name: "App",
                components: {
            ...
            y = v,
            b = (o("2b2b"), Object(g["a"])(y, i, r, !1, null, null, null)),
            k = b.exports,
            P = o("8c4f"),
            z = function() {
                var e = this,
                    ...
                    save: function() {
                        ...
                        p.changePassword({
                            ...
                            e.$toast.open({
                                ...
                                type: "is-success"
                            }), e.$parent.close(), e.$router.go()
                        }))["catch"]((function(a) {
                            "object" != Object(A["a"])(a.response.data.data) && e.handleError(a), F.a.forEach(a.response.data, (function(a) {
                                F.a.forEach(a, (function(a, o) {
            ...
            L = _,
            R = Object(g["a"])(L, N, j, !1, null, null, null),
            T = R.exports,
            E = {
                name: "Menu",
                data: function() {
            ...
            $ = E,
            x = (o("d7ef"), Object(g["a"])($, C, S, !1, null, "cd57c856", null)),
            q = x.exports,
            B = function() {
                var e = this,
                    a = e.$createElement,
                    ...
                    toggleButton: function(e) {
                        ...
                        this.active ? (this.active = !1, this.$store.commit("updateTreeNode", {
                            ...
                            a.$store.commit("updateTreeNode", {
                                children: F.a.filter(o.files, ["type", "dir"]),
                                path: e.path
            ...
            I = M,
            Z = (o("4aca"), Object(g["a"])(I, V, H, !1, null, "45d0a157", null)),
            W = Z.exports,
            G = {
                name: "Tree",
                components: {
            ...
            K = G,
            Y = (o("b069"), Object(g["a"])(K, B, O, !1, null, null, null)),
            J = Y.exports,
            Q = function() {
                var e = this,
                    a = e.$createElement,
            ...
            ne = oe,
            ie = (o("86e1"), Object(g["a"])(ne, Q, X, !1, null, "47c7e221", null)),
            re = ie.exports,
            te = function() {
                var e = this,
                    a = e.$createElement,
            ...
            le = {
                ...
                computed: {
                    images: function() {
                        var e = this;
                        return F.a.filter(this.$store.state.cwd.content, (function(a) {
            ...
            de = le,
            ue = (o("14a0"), Object(g["a"])(de, te, se, !1, null, "45cb0efd", null)),
            ce = ue.exports,
            pe = function() {
                var e = this,
                    a = e.$createElement,
            ...
            fe = (o("c975"), o("4795"), {
                ...
                methods: {
                    ...
                    searchFiles: F.a.debounce((function(e) {
                    ...
                    getDir: function(e) {
                        var a = this;
                        this.searching = !0, p.getDir({
                            dir: e
                        }).then((function(o) {
                            a.searching = !1, a.pending_getdirs--, F.a.forEach(o.files, (function(o) {
                                o.name.toLowerCase().indexOf(a.term.toLowerCase()) > -1 && a.results.push({
                                    file: o,
                                    dir: e
                                })
                            })), F.a.forEach(F.a.filter(o.files, ["type", "dir"]), (function(e) {
            ...
            ge = fe,
            he = Object(g["a"])(ge, pe, me, !1, null, null, null),
            we = he.exports,
            ve = function() {
                var e = this,
                    a = e.$createElement,
            ...
            ke = be,
            Pe = Object(g["a"])(ke, ve, ye, !1, null, null, null),
            ze = Pe.exports,
            Ue = function() {
                var e = this,
                    a = e.$createElement,
            ...
            Ae = je,
            De = (o("f507"), Object(g["a"])(Ae, Ue, Ce, !1, null, "07f55d0a", null)),
            Fe = De.exports,
            _e = o("4eb5"),
            Le = o.n(_e);
        n["default"].use(Le.a);
        var Re = {
                ...
                computed: {
                    breadcrumbs: function() {
                        ...
                        return F.a.forEach(F.a.split(this.$store.state.cwd.location, "/"), (function(o) {
                            e += o + "/", a.push({
                                name: o,
                                path: e
                            })
                        })), F.a.filter(a, (function(e) {
                            return e.name
                        }))
                    },
                    content: function() {
                    ...
                    totalCount: function() {
                        return Number(F.a.sumBy(this.$store.state.cwd.content, (function(e) {
                ...
                methods: {
                    ...
                    filterEntries: function(e) {
                        ...
                        if (this.hasFilteredEntries = !1, !this.showAllEntries && "undefined" !== typeof o && o.length > 0) {
                            var n = [];
                            return F.a.forEach(e, (function(e) {
                                var i = !1;
                                F.a.forEach(o, (function(o) {
                                    if ("undefined" !== typeof o && o.length > 0) {
                                        var n = o,
                                            r = n.endsWith("/") ? "dir" : "file";
                                        n = n.replace(/\/$/, "");
                                        var t = n.startsWith("/"),
                                            s = t ? "/" + e.path : e.name;
                                        n = t ? "/" + n : n, n = n.replace(/[.+?^${}()|[\]\\]/g, "\\$&").replace(/\*/g, ".$&");
                                        var l = new RegExp("^" + n + "$", "iu");
                                        if (e.type == r && l.test(s)) return i = !0, a.hasFilteredEntries = !0, !1
                                    }
                                })), i || n.push(e)
                            })), n
                        }
                    ...
                    getSelected: function() {
                        return F.a.reduce(this.checked, (function(e, a) {
                            return e.push(a), e
                        }), [])
                    },
                    ...
                    preview: function(e) {
                        var a = null;
                        this.isImage(e.path) && (a = ce), this.isText(e.path) && (a = re), this.$modal.open({
                            parent: this,
                            props: {
                                item: e
                            },
                    ...
                    customSort: function(e, a, o, n) {
                        return "back" == e.type ? -1 : "back" == a.type ? 1 : "dir" == e.type && "dir" != a.type ? -1 : "dir" == a.type && "dir" != e.type ? 1 : a.type == e.type ? e[n] === a[n] ? this.customSort(e, a, !1, "name") : F.a.isString(e[n]) ? e[n].localeCompare(a[n]) * (o ? -1 : 1) : (e[n] < a[n] ? -1 : 1) * (o ? -1 : 1) : void 0
                    }
                }
            },
            Te = Re,
            Ee = (o("7182"), Object(g["a"])(Te, z, U, !1, null, "081c0a81", null)),
            $e = Ee.exports,
            xe = function() {
                var e = this,
                    a = e.$createElement,
            ...
            Ve = (o("7db0"), {
                ...
                data: function() {
                    return {
                        ...
                        formErrors: {},
                        permissions: {
                            read: !!F.a.find(this.user.permissions, (function(e) {
                                return "read" == e
                            })),
                            write: !!F.a.find(this.user.permissions, (function(e) {
                                return "write" == e
                            })),
                            upload: !!F.a.find(this.user.permissions, (function(e) {
                                return "upload" == e
                            })),
                            download: !!F.a.find(this.user.permissions, (function(e) {
                                return "download" == e
                            })),
                            batchdownload: !!F.a.find(this.user.permissions, (function(e) {
                                return "batchdownload" == e
                            })),
                            zip: !!F.a.find(this.user.permissions, (function(e) {
                                return "zip" == e
                            }))
                        }
                    }
                ...
                methods: {
                    ...
                    getPermissionsArray: function() {
                        return F.a.reduce(this.permissions, (function(e, a, o) {
            ...
            He = Ve,
            Me = Object(g["a"])(He, Be, Oe, !1, null, null, null),
            Ie = Me.exports,
            Ze = {
                name: "Users",
                components: {
                ...
                methods: {
                        ...
                        this.$dialog.confirm({
                            ...
                            onConfirm: function() {
                                p.deleteUser({
                                    ...
                                    a.users = F.a.reject(a.users, (function(a) {
                    ...
                    editUser: function(e) {
                        ...
                        e.username ? this.$modal.open({
                            ...
                            events: {
                                updated: function(e) {
                                    a.users.splice(F.a.findIndex(a.users, {
                                        username: e.username
                                    }), 1, e)
                                }
                            }
            ...
            We = Ze,
            Ge = (o("abb7"), Object(g["a"])(We, xe, qe, !1, null, "de886392", null)),
            Ke = Ge.exports,
            Ye = o("2f62"),
                ...
                methods: {
                    lang: function(e) {
                        for (var a = {
                                ...
                                arabic: Ya,
                                portuguese_br: Qa
                            }, o = ao.state.config.language, n = arguments.length, i = new Array(n > 1 ? n - 1 : 0), r = 1; r < n; r++) i[r - 1] = arguments[r];
                        var t = i;
                    ...
                    formatBytes: function(e) {
                        ...
                        return parseFloat((e / Math.pow(o, r)).toFixed(n)) + " " + i[r]
                    },
                    formatDate: function(e) {
                        return Qe.a.unix(e).format(ao.state.config.date_format ? ao.state.config.date_format : "YY/MM/DD hh:mm:ss")
                    },
                    checkUser: function() {
                        var e = this;
                        p.getUser().then((function(a) {
                            a.username !== ao.state.user.username && (e.$store.commit("destroyUser", a), e.$toast.open({
                    ...
                    getDownloadLink: function(e) {
                        return n["default"].config.baseURL + "/download&path=" + encodeURIComponent(u["Base64"].encode(e))
                    },
                    hasPreview: function(e) {
                        return this.isText(e) || this.isImage(e)
                    },
                    isText: function(e) {
                        return this.hasExtension(e, ao.state.config.editable)
                    },
                    isImage: function(e) {
                        return this.hasExtension(e, [".jpg", ".jpeg", ".gif", ".png", ".bmp", ".svg", ".tiff", ".tif"])
                    },
                    hasExtension: function(e, a) {
                        return !F.a.isEmpty(a) && new RegExp("(" + a.join("|").replace(/\./g, "\\.") + ")$", "i").test(e)
                    },
        ...
        var ao = new Ye["a"].Store({
            ...
            getters: {
                hasPermissions: function(e) {
                    return function(a) {
                        return F.a.isArray(a) ? F.a.intersection(e.user.permissions, a).length == a.length : !!F.a.find(e.user.permissions, (function(e) {
                            return e == a
                        }))
                    }
                }
            ...
            mutations: {
                ...
                setCwd: function(e, a) {
                    e.cwd.location = a.location, e.cwd.content = [], F.a.forEach(F.a.sortBy(a.content, [function(e) {
                        return F.a.toLower(e.type)
                    }]), (function(a) {
        ...
        var oo = new P["a"]({
            ...
            ro = o("caf9");
        o("15f5"), o("b2a2");
        n["default"].config.productionTip = !1, n["default"].config.baseURL = window.location.origin + window.location.pathname + "?r=", d.a.defaults.withCredentials = !0, d.a.defaults.baseURL = n["default"].config.baseURL, d.a.defaults.headers["Content-Type"] = "application/json", n["default"].use(io.a, {
            defaultIconPack: "fas"
        }), n["default"].use(ro["a"], {
            preLoad: 1.3
        }), n["default"].mixin(eo), new n["default"]({
            router: oo,
            store: ao,
            created: function() {
                var e = this;
